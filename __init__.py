...
Швидкий старт:
    python test_system.py  # Перевірка системи
    jupyter notebook notebooks/00_test_connections.ipynb  # Тестування
    jupyter notebook notebooks/03_data_matching.ipynb     # Основний аналіз
"""
